...
void handle_compress_file()
{
    ...
    cout << "\n[RUN]: Now, provide the path to the folder where the file must be discharged, as well the name of the compressed file. Example: C:\\Downloads\\MyOtherFolder\\compressed.me\n";
